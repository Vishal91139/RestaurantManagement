    ...
    <div className='flex px-15 pt-8 '>
          <div className='leftpart w-[60%] relative pl-12 py-20'>
            <h1 className='text-3 flex relative'>EXPERIENCE OF REAL RECIPES TASTE
              <img className='w-22 h-22 absolute object-contain bottom-2 left-80' src="../../../public/Menu/Breakfast/Breakfast3.png" />
            </h1>
            <div className='flex items-center justify-between mt-10 '>
              <div className='flex items-center gap-4'>
                <img className='border-8 rounded-full border-orange-300' width={80} src="../../../public/Menu/Breakfast/Breakfast1.png" alt="Food" />
